...
public class PracticeBrailleNumbers extends AppCompatActivity {
    ...
    private void setLayout(int layoutResID) {
        ...
        /*if (currentCharIndex == charactersList1.size() - 1) {
            ...
            charMap = brailleScript.getNumbersMap();
    ...
    private void getPracticeHistory() {
        ...
        String characters1 = sharedPreferences.getString("Practice 2 chars1", null);
    ...
    private ArrayList<Character> getCharactersList(String characters) {
        ...
        if (characters != null) {
            ...
            ArrayList<Character> chars = new ArrayList<>(brailleScript.getNumbersMap().keySet());
